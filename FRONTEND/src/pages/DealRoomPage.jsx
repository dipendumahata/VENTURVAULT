...
import { fetchDealRoomDetails, clearCurrentDealRoom } from '../store/dataSlice.js';
import { useSocket } from '../context/SocketContext.jsx';
import PageLoader from '../components/layout/PageLoader.jsx';
import API from '../services/api.js';
import { motion, AnimatePresence } from 'framer-motion';

const SendIcon = () => ( <svg viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M1.101 21.757 23.8 12.028 1.101 2.3l.011 7.912 13.623 1.816-13.623 1.817-.011 7.912z"></path></svg> );
